...
async function insertSampleData(db: any) {
  ...
  const sampleGuests = [
    ['G001', 'Sok Pisey', 'សុខ ពិសី', 500000.00, 125.00, 'QR_Code', 'Bride', 0],
    ['G002', 'Chan Dara', 'ច័ន្ទ ដារា', 200000.00, 50.00, 'Cash', 'Groom', 0],
    ['G003', 'Lim Sophea', 'លឹម សុភា', 1000000.00, 250.00, 'QR_Code', 'Bride_Parents', 0],
    ['G004', 'Pov Samnang', 'ពៅ សំណាង', 300000.00, 75.00, 'Cash', 'Groom_Parents', 0],
    ['G005', 'Keo Malika', 'កែវ ម៉ាលីកា', 400000.00, 100.00, 'QR_Code', 'Bride', 0],
    ['G006', 'Heng Rithea', 'ហេង រិទ្ធា', 0.00, 0.00, null, 'Groom', 0],
    ['G007', 'Sok Pisey', 'សុខ ពិសី', 300000.00, 75.00, 'Cash', 'Bride', 1],
    ['G008', 'John Smith', 'ចន ស្មីត', 200000.00, 50.00, 'QR_Code', 'Groom', 0],
    ['G009', 'Mary Johnson', 'ម៉ារី ចនសុន', 150000.00, 37.50, 'Cash', 'Bride', 0],
    ['G010', 'David Wilson', 'ដាវីត វីលសុន', 0.00, 0.00, null, 'Groom_Parents', 0],
  ];
